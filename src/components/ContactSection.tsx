...
const ContactSection = () => {
  ...
  return <section id="contact" ref={ref} className={`py-6 md:py-8 lg:py-12 bg-secondary/30 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
